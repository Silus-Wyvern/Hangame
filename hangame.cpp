...
// Export the loader entry undecorated as "load" so patch.dll's ASI loader
// resolves it via GetProcAddress(h, "load"); __stdcall would otherwise
// decorate it to _load@0.
...
// The loader resolves this by name. Exported undecorated as "load" 
//  via the /EXPORT linker pragma above so GetProcAddress(h, "load") succeeds despite
